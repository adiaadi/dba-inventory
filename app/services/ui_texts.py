...
DEFAULT_UI_TEXTS = [
    ...
    {"key": "auth.login_title", "category": "Auth", "label": "Portal login title", "default": "Portal Login"},
    {"key": "auth.login_hint", "category": "Auth", "label": "Portal login hint", "default": "Sign in to access DATABASE INVENTORY."},
