...
DEFAULT_UI_TEXTS = [
    ...
    {"key": "panel.environment_estate", "category": "Panels", "label": "Environment estate panel", "default": "Environment Estate"},
    {"key": "panel.environment_estate_note", "category": "Panels", "label": "Environment estate note", "default": "PROD / TEST / DEV"},
    ...
    {"key": "panel.operating_systems_note", "category": "Panels", "label": "Operating systems note", "default": "Ubuntu / OEL / Windows"},
    ...
    {"key": "label.product", "category": "Table", "label": "Product column", "default": "Product"},
